...
def display_inventory():
    ...
    ''')
        if potion == '1':
            ...
            if 'усиление силы' in player['inventory']:
                potion = input('''Желаешь выпить усиление силы?
            1 - да
            2 - нет
            ''')
                if potion == '1':
                    player['attack'] *= 10
                print(f'Готово! Теперь сила равна  {player["attack"]}')
                player['inventory'].remove('усиление силы')
